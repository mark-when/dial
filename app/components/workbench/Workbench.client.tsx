  ...
  ({ chatStarted, isStreaming, actionRunner, metadata, updateChatMestaData }: WorkspaceProps) => {
    ...
    return (
      chatStarted && (
        ...
        >
          <div
            className={classNames('fixed inset-0 z-0 transition-[left,width] duration-200 bolt-ease-cubic-bezier', {
          ...
          >
            <div className="absolute inset-0">
              <div className="h-full flex flex-col bg-bolt-elements-background-depth-2 border-bolt-elements-borderColor shadow-sm overflow-hidden">
